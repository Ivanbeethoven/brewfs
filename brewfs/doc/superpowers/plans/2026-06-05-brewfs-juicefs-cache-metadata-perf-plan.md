...
- Artifact: `/mnt/slayerfs/brewfs/brewfs/docker/compose-xfstests/artifacts/juicefs-perf-run-1780562982-7892`
- Command recorded in the previous gap plan:

```bash
cd /mnt/slayerfs/brewfs
bash brewfs/docker/compose-xfstests/run_juicefs_perf.sh \
...
- Artifact: `/mnt/slayerfs/brewfs/brewfs/docker/compose-xfstests/artifacts/perf-run-1780672743-23142`
...
Fio profile defaults from `/mnt/slayerfs/brewfs/brewfs/docker/compose-xfstests/run_perf_in_container.sh`:
...
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/vfs/reader.go`
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/chunk/cached_store.go`
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/chunk/prefetch.go`
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/chunk/singleflight.go`
...
- `/mnt/slayerfs/brewfs/brewfs/src/vfs/io/reader.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/vfs/cache/prefetch.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/chunk/reader.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/chunk/store.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/chunk/cache.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/chunk/page_cache.rs`
...
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/vfs/writer.go`
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/chunk/cached_store.go`
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/chunk/disk_cache.go`
...
- `/mnt/slayerfs/brewfs/brewfs/src/vfs/io/writer.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/vfs/cache/write_back.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/vfs/config.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/vfs/stats.rs`
...
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/meta/openfile.go`
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/meta/base.go`
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/meta/redis.go`
- `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/meta/redis_csc.go`
...
- `/mnt/slayerfs/brewfs/brewfs/src/meta/client/cache.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/meta/client/mod.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/meta/stores/redis/mod.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/vfs/handles.rs`
- `/mnt/slayerfs/brewfs/brewfs/src/vfs/fs/mod.rs`
...
```bash
cd /mnt/slayerfs/brewfs
docker compose -f brewfs/docker/compose-xfstests/docker-compose.redis-perf.yml pull --ignore-pull-failures
bash brewfs/docker/build_brewfs_host_binary.sh
```
...
cd /mnt/slayerfs/brewfs
for root in \
  "$(ls -1dt brewfs/docker/compose-xfstests/artifacts/perf-run-* | head -1)" \
  "$(ls -1dt brewfs/docker/compose-xfstests/artifacts/juicefs-perf-run-* | head -1)"
do
  echo "== $root"
...
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/chunk/store.rs`
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/vfs/stats.rs`
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/vfs/fs/mod.rs`
...
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/meta/client/cache.rs`
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/meta/client/mod.rs`
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/vfs/fs/mod.rs`
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/vfs/handles.rs`
...
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/vfs/cache/prefetch.rs`
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/vfs/io/reader.rs`
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/chunk/store.rs`
...
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/chunk/store.rs`
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/chunk/cache.rs`
- Modify: `/mnt/slayerfs/brewfs/brewfs/src/chunk/page_cache.rs`
...
- Modify only if evidence requires it: `/mnt/slayerfs/brewfs/brewfs/src/vfs/io/writer.rs`
- Modify only if evidence requires it: `/mnt/slayerfs/brewfs/brewfs/src/vfs/cache/write_back.rs`
- Modify only if evidence requires it: `/mnt/slayerfs/brewfs/brewfs/src/vfs/config.rs`
...
- Analyze: `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/meta/redis_csc.go`
- Analyze: `/mnt/slayerfs/brewfs/brewfs/src/meta/stores/redis/mod.rs`
- Modify only after approval: `/mnt/slayerfs/brewfs/brewfs/src/meta/stores/redis/mod.rs`
...
```bash
cd /mnt/slayerfs/brewfs
root="$(ls -1dt brewfs/docker/compose-xfstests/artifacts/perf-run-* | head -1)"
echo "artifact=$root"
