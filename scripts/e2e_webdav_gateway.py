...
check("Depth 1 root PROPFIND lists root", status == 207, f"status={status} body={body[:400]!r}")
...
check("Depth infinity PROPFIND rejected with 501", status == 501 and b"propfind-finite-depth" in body, f"status={status} body={body[:400]!r}")
