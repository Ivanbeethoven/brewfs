...
BREWFS_CACHED_SUB_BLOCK_AUTO_FREEZE_MIN_AGE_MS=${BREWFS_CACHED_SUB_BLOCK_AUTO_FREEZE_MIN_AGE_MS:-}
...
EOF
    ...
    append_env_export BREWFS_CACHED_SUB_BLOCK_AUTO_FREEZE_MIN_AGE_MS
